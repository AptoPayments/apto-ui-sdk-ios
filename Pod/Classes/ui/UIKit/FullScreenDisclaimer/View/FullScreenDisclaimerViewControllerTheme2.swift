...
class FullScreenDisclaimerViewControllerTheme2: AptoViewController {
         ...
         cancelActionTitle: String)
    {
        ...
        contentPresenterView = ContentPresenterView(uiConfig: uiConfiguration)
        titleLabel = ComponentCatalog.largeTitleLabelWith(text: disclaimerTitle.podLocalized(),
    ...
    private final func set(disclaimer: Content) {
        if case .externalURL = disclaimer {
