...
class KeyboardView: UIView {
    ...
    init() {
        topRowView = KeyboardRowView(leftButton: KeyboardButton(type: .digit(digit: "1")),
                                     centerButton: KeyboardButton(type: .digit(digit: "2")),
                                     rightButton: KeyboardButton(type: .digit(digit: "3")))
        middleRowView = KeyboardRowView(leftButton: KeyboardButton(type: .digit(digit: "4")),
                                        centerButton: KeyboardButton(type: .digit(digit: "5")),
                                        rightButton: KeyboardButton(type: .digit(digit: "6")))
        bottomRowView = KeyboardRowView(leftButton: KeyboardButton(type: .digit(digit: "7")),
                                        centerButton: KeyboardButton(type: .digit(digit: "8")),
                                        rightButton: KeyboardButton(type: .digit(digit: "9")))
        symbolsRowView = KeyboardRowView(leftButton: KeyboardButton(type: .digit(digit: "*")),
