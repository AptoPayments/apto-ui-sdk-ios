...
protocol CallActionButtonsViewDelegate: AnyObject {
...
class CallActionButtonsView: UIView {
    ...
    init(uiConfig: UIConfig) {
        ...
        speakerButton = createSelectableButton(asset: "speaker")
        muteButton = createSelectableButton(asset: "mute")
        keypadButton = createButton(asset: "dialpad")
