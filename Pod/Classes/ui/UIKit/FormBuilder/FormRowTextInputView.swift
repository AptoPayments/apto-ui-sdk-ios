...
open class FormRowTextInputView: FormRowLeftLabelView, UITextFieldDelegate {
    ...
    override open var isEnabled: Bool {
        didSet {
            ...
            if !isEnabled {
                textField.textColor = uiConfig.textSecondaryColorDisabled
            ...
            validateText(textValidator, text: textField.text)
        }
    }
    ...
    open func textFieldShouldReturn(_: UITextField) -> Bool {
    ...
    @objc func textFieldDidBeginEditingHandler(_: UITextField) {
        focus()
    }

    @objc func textFieldDidEndEditingHandler(_: UITextField) {
        looseFocus()
    }

    @objc func textFieldDidChangeHandler(_: UITextField) {
        presentPassedValidationResult()
    }

    @objc public func textField(_: UITextField,
