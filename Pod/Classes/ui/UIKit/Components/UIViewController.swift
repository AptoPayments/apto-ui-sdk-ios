...
extension UIViewController: ViewControllerProtocol {
    public func showNavPreviousButton(_ tintColor: UIColor? = nil) {
        installNavLeftButton(UIImage.imageFromPodBundle("top_back_default"),
                             tintColor: tintColor,
    ...
    public func showNavNextButton(tintColor: UIColor?) {
        installNavRightButton(UIImage.imageFromPodBundle("top_next_default.png"),
                              tintColor: tintColor,
                              title: nil,
                              accessibilityLabel: "Navigation Next Button",
                              target: self,
    ...
    public func showNavCancelButton(_ tintColor: UIColor? = nil) {
        installNavLeftButton(UIImage.imageFromPodBundle("top_close_default"),
                             tintColor: tintColor,
