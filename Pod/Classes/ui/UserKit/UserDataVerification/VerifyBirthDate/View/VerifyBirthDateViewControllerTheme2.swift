...
class VerifyBirthDateViewControllerTheme2: VerifyBirthDateViewControllerProtocol {
    ...
    init(uiConfig: UIConfig, presenter: VerifyBirthDateEventHandler) {
        ...
        titleLabel = ComponentCatalog.largeTitleLabelWith(text: "auth.verify_birthdate.title".podLocalized(),
                                                          multiline: false,
                                                          uiConfig: uiConfig)
        explanationLabel = ComponentCatalog.formLabelWith(text: "auth.verify_birthdate.explanation".podLocalized(),
                                                          multiline: true,
                                                          lineSpacing: uiConfig.lineSpacing,
                                                          letterSpacing: uiConfig.letterSpacing,
                                                          uiConfig: uiConfig)
        super.init(uiConfiguration: uiConfig)
        submitButton = ComponentCatalog.buttonWith(title: "auth.verify_birthdate.call_to_action.title".podLocalized(),
                                                   showShadow: false,
