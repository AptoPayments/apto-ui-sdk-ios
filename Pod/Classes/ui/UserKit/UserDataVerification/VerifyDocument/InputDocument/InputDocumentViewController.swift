...
class InputDocumentViewController: AptoViewController {
    ...
    private func setupViewModelSubscriptions() {
        ...
        _ = viewModel.retakeButtonTitle.observeNext { retakeButtonTitle in
            guard let retakeButtonTitle = retakeButtonTitle,
                  let attributedTitle = self.retakePhotoButton.attributedTitle(for: .normal)
            else {
                return
            }
        ...
        _ = viewModel.state.observeNext { newState in
            ...
            case let .checkFrontPhoto(image), let .checkBackPhoto(image):
    ...
    private func showDocumentCapture() {
        ...
        setNavigationBar(tintColor: UIColor.white)
    }
    ...
    private func showCheckDocument(image: UIImage) {
        ...
        setNavigationBar(tintColor: UIColor.black)
    }
