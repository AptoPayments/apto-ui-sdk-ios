...
class AuthViewControllerTheme2: AuthViewControllerProtocol {
    ...
    init(uiConfiguration: UIConfig, mode: AptoUISDKMode, eventHandler: AuthEventHandler) {
        ...
        explanationLabel = ComponentCatalog.formLabelWith(text: "auth.input_phone.explanation".podLocalized(),
                                                          multiline: true,
                                                          lineSpacing: uiConfiguration.lineSpacing,
                                                          letterSpacing: uiConfiguration.letterSpacing,
                                                          uiConfig: uiConfiguration)
        super.init(uiConfiguration: uiConfiguration)
        continueButton = ComponentCatalog.buttonWith(title: "auth.input_phone.call_to_action.title".podLocalized(),
                                                     showShadow: false,
