...
class CardMonthlyStatsViewController: AptoViewController {
    ...
    init(uiConfiguration: UIConfig, presenter: CardMonthlyStatsPresenterProtocol) {
        ...
        monthsView = CardMonthlyStatsMonthsView(uiConfig: uiConfiguration)
        graphView = PieChartView(frame: .zero)
        graphSummaryView = CardMonthlyStatsGraphSummaryView(uiConfig: uiConfiguration)
...
private extension CardMonthlyStatsViewController {
    ...
    var deleteAnimation: UITableView.RowAnimation {
        guard let previousDate = previousDate else { return .automatic }
...
extension CardMonthlyStatsViewController: CardMonthlyStatsMonthsViewDelegate {
    ...
    func centerLabelTapped(associatedDate _: Date?) {
...
extension CardMonthlyStatsViewController: PieChartViewDataSource {
    ...
    func colorForSlice(at _: Int) -> UIColor {
        return uiConfiguration.uiTertiaryColor
    }

    func selectedColorForSlice(at _: Int) -> UIColor {
    ...
    func imageTintColorForSlice(at _: Int) -> UIColor {
...
extension CardMonthlyStatsViewController: PieChartViewDelegate {
    ...
    func didDeselectSlice(at _: Int) {
        selectedSlice = nil
        showSummaryTotal()
        spentListTableView.reloadData()
    }
