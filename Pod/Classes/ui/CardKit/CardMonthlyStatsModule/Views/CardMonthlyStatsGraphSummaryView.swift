...
class CardMonthlyStatsGraphSummaryView: UIView {
    ...
    init(uiConfig: UIConfig) {
        ...
        titleLabel = ComponentCatalog.timestampLabelWith(text: "", textAlignment: .center, uiConfig: uiConfig)
        amountLabel = ComponentCatalog.mainItemRegularLabelWith(text: "", textAlignment: .center, uiConfig: uiConfig)
        differenceLabel = PaddingLabel(frame: .zero)
