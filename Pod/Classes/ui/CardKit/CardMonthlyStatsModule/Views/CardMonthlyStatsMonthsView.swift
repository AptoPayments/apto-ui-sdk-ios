...
protocol CardMonthlyStatsMonthsViewDelegate: AnyObject {
...
class CardMonthlyStatsMonthsView: UIView {
    ...
    init(uiConfig: UIConfig) {
        ...
        leftLabel = ComponentCatalog.timestampLabelWith(text: "", uiConfig: uiConfig)
        centerLabel = ComponentCatalog.sectionTitleLabelWith(text: "", textAlignment: .center, uiConfig: uiConfig)
        rightLabel = ComponentCatalog.timestampLabelWith(text: "", textAlignment: .right, uiConfig: uiConfig)
    ...
    @objc func rightLabelTapped() {
        guard let nextMonthDate = nextMonthDate else { return }
