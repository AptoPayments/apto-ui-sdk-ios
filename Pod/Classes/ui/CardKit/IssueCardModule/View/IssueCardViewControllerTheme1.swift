...
class IssueCardViewControllerTheme1: ShiftViewController {
  ...
  init(uiConfiguration: UIConfig, eventHandler: IssueCardPresenterProtocol) {
...
private extension IssueCardViewControllerTheme1 {
  ...
  func setUpErrorMessageLabel() {
    errorMessageLabel = ComponentCatalog.errorMessageLabel(
      text: "issue_card.issue_card.generic_error.description".podLocalized(),
  ...
  private func setUpErrorTitleLabel() {
    errorTitleLabel = ComponentCatalog.errorTitleLabel(text: "issue_card.issue_card.generic_error.title".podLocalized(),
                                                       uiConfig: uiConfiguration)
  ...
  private func setUpRetryButton() {
    let button = ComponentCatalog.buttonWith(title: "issue_card.issue_card.generic_error.primary_cta".podLocalized(),
