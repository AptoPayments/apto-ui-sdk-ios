...
public class AddMoneyView: UIView {
    ...
    private lazy var headerTextView = HeaderTextView(uiconfig: self.uiConfiguration,
                                                     text: "load_funds.selector_dialog.title".podLocalized())
    private(set) lazy var item1ActionDetailView: DetailActionView = {
        DetailActionView(uiconfig: self.uiConfiguration,
    ...
    private(set) lazy var item2ActionDetailView: DetailActionView = {
        DetailActionView(uiconfig: self.uiConfiguration,
        ...
        UIView.animate(withDuration: 0.3, animations: { [dimView] in
            ...
            UIView.animate(withDuration: 0.3,
                           ...
                           animations: { [weak self] in
                               self?
                                   .topConstraint?
                                   .update(offset: superview.frame.height - CGFloat(Constants.containerViewHeight) - 30)
