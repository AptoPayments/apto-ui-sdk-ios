...
class KYCViewControllerTheme1: KYCViewControllerProtocol {
...
private extension KYCViewControllerTheme1 {
  func setUpUI() {
...
extension KYCViewControllerTheme1: ContentPresenterViewDelegate {
