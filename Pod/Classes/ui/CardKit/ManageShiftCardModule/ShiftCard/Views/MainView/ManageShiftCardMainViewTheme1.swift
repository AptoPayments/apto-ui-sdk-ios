...
private extension ManageShiftCardMainViewTheme1 {
  func setUpUI(uiConfiguration: UIConfig) {
  ...
  func setUpCreditCardView(uiConfiguration: UIConfig) {
    creditCardView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(cardTapped)))
  }

  func setUpTapToManageView(uiConfiguration: UIConfig) {
  ...
  func setUpInvalidBalanceView(uiConfiguration: UIConfig) -> ManageShiftCardTopMessageView {
  ...
  func setUpNoBalanceView(uiConfiguration: UIConfig) -> ManageShiftCardTopMessageView {
  ...
  func setUpActivatePhysicalCardView(uiConfiguration: UIConfig) -> ManageShiftCardTopMessageView {
