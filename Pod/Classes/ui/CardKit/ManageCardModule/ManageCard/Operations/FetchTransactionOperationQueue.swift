...
class FetchTransactionOperationQueue {
    ...
    private var isReloadInProgress: Bool {
        guard let reloadOperation = reloadOperation else {
            return false
        }
    ...
    private var isLoadMoreInProgress: Bool {
        guard let loadMoreOperation = loadMoreOperation else {
            return false
        }
    ...
    private var isBackgroundRefreshInProgress: Bool {
        guard let backgroundRefreshOperation = backgroundRefreshOperation else {
            return false
        }
