...
class ManageCardMainViewTheme2: UIView, CardPresentationProtocol {
    ...
    init(uiConfiguration: UIConfig, cardStyle: CardStyle?, delegate: ManageCardMainViewDelegate) {
        ...
        creditCardView = CreditCardView(uiConfiguration: uiConfiguration, cardStyle: cardStyle)
    ...
    func set(card: Card?) {
        ...
        creditCardView.configure(with: PCIConfiguration(
    ...
    func set(cardNetwork: CardNetwork?) {
        creditCardView.set(cardNetwork: cardNetwork)
    }
    ...
    func setSpendable(amount _: Amount?, nativeAmount _: Amount?) {}
