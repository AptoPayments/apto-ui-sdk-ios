//
//  AptoCardTransactionDetailsPresenter.swift
//  AptoSDK
//
...
class AptoCardTransactionDetailsPresenter: AptoCardTransactionDetailsPresenterProtocol {
    // swiftlint:disable implicitly_unwrapped_optional
    var view: AptoCardTransactionDetailsViewProtocol!
    var interactor: AptoCardTransactionDetailsInteractorProtocol!
    var router: AptoCardTransactionDetailsRouterProtocol!
    // swiftlint:enable implicitly_unwrapped_optional
    var viewModel: AptoCardTransactionDetailsViewModel
    var analyticsManager: AnalyticsServiceProtocol?
    let rowsPerPage = 20

    init() {
        viewModel = AptoCardTransactionDetailsViewModel()
    }
    ...
    private func refreshViewModelWith(transaction: Transaction) {
        ...
        // address
        viewModel.transactionDate.send(format(date: transaction.createdAt))
...
private extension AptoCardTransactionDetailsPresenter {
    ...
    func format(date: Date?) -> String? {
        ...
        return AptoCardTransactionDetailsPresenter.dateFormatterWithYear.string(from: date)
    }
