...
typealias AptoCardTransactionDetailsViewControllerProtocol = AptoViewController & AptoCardTransactionDetailsViewProtocol

protocol AptoCardTransactionDetailsPresenterProtocol: class {
...
protocol AptoCardTransactionDetailsViewProtocol: class, ViewControllerProtocol {
  func finishUpdates()
