...
protocol PhysicalCardActivationSucceedPresenterProtocol: AnyObject {
...
protocol PhysicalCardActivationSucceedRouter: AnyObject {
...
protocol PhysicalCardActivationSucceedModuleProtocol: UIModuleProtocol, PhysicalCardActivationSucceedRouter {
    var activationCompletion: (() -> Void)? { get set }
}
