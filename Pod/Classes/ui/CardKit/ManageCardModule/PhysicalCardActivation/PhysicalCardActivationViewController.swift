...
class PhysicalCardActivationViewController: AptoViewController {
    ...
    init(uiConfiguration: UIConfig, presenter: PhysicalCardActivationPresenterProtocol) {
        ...
        titleLabel = ComponentCatalog.largeTitleLabelWith(text: title, uiConfig: uiConfiguration)
        cardView = CreditCardView(uiConfiguration: uiConfiguration, cardStyle: nil)
        let addressTitle = "manage_card.activate_physical_card.shipping_address".podLocalized()
        addressTitleLabel = ComponentCatalog.sectionTitleLabelWith(text: addressTitle, uiConfig: uiConfiguration)
        footerLabel = ContentPresenterView(uiConfig: uiConfiguration)
        super.init(uiConfiguration: uiConfiguration)
        let buttonTitle = "manage_card.activate_physical_card.call_to_action.title".podLocalized()
        activateButton = ComponentCatalog.buttonWith(title: buttonTitle,
