...
class ChangePasscodeViewController: AptoViewController {
    ...
    init(uiConfiguration: UIConfig, presenter: ChangePasscodePresenterProtocol) {
        ...
        explanationLabel = ComponentCatalog.formLabelWith(text: " ", multiline: true,
        ...
        forgotPasscodeButton = ComponentCatalog.formTextLinkButtonWith(title: forgotPasscodeTitle,
