...
class CreatePasscodeViewController: AptoViewController {
    ...
    init(uiConfiguration: UIConfig, presenter: CreatePasscodePresenterProtocol) {
        ...
        titleLabel = ComponentCatalog.largeTitleLabelWith(text: "biometric.create_pin.title".podLocalized(),
                                                          multiline: false, uiConfig: uiConfiguration)
        explanationLabel = ComponentCatalog.formLabelWith(text: "biometric.create_pin.description".podLocalized(),
        ...
        detailedExplanationLabel = ComponentCatalog.itemDescriptionLabelWith(text: detailedExplanation,
                                                                             multiline: true,
                                                                             uiConfig: uiConfiguration)
        pinEntryView = UIPinEntryTextField(size: 4, frame: CGRect(x: 0, y: 0, width: 168, height: 64),
