...
public class CreditCardView: UIView {
    ...
    public func set(validFundingSource: Bool) {
        hasValidFundingSource = validFundingSource
    ...
    fileprivate func set(cardNetwork: CardNetwork, enabled _: Bool, alpha _: CGFloat) {
...
private extension CreditCardView {
    ...
    func updateCardNetwork() {
        ...
        if let cardNetwork = cardNetwork {
            set(cardNetwork: cardNetwork, enabled: enabled, alpha: 1)
        }
    }
}
