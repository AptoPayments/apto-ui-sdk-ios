...
class P2PTransferStorageSpy: P2PTransferProtocol {
    func getRecipient(_: String, userToken _: String, phoneCode _: String?, phoneNumber _: String?, email _: String?, completion _: @escaping (P2PTransferRecipientResult) -> Void) {}

    func inviteUser(_: String, userToken _: String, invitation _: P2PInvite, completion _: @escaping (P2PInviteResult) -> Void) {}

    func transfer(_: String, userToken _: String, transferRequest _: P2PTransferRequest, completion _: @escaping (P2PTransferResult) -> Void) {}
}
