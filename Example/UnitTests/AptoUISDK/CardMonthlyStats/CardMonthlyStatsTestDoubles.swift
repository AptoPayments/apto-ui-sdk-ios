...
class CardMonthlyStatsInteractorSpy: CardMonthlyStatsInteractorProtocol {
    ...
    func fetchMonthlySpending(date: Date, callback _: @escaping Result<MonthlySpending, NSError>.Callback) {
    ...
    func isStatementsFeatureEnabled(callback _: @escaping (_ isEnabled: Bool) -> Void) {
