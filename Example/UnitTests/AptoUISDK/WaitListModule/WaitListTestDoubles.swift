...
class WaitListInteractorSpy: WaitListInteractorProtocol {
    ...
    func reloadApplication(completion _: @escaping Result<CardApplication, NSError>.Callback) {
...
class CardWaitListInteractorSpy: CardWaitListInteractorProtocol {
    ...
    func reloadCard(completion _: @escaping Result<Card, NSError>.Callback) {
