...
class AuthInteractorTest: XCTestCase {
    ...
    private lazy var authConfig = AuthModuleConfig(primaryAuthCredential: .phoneNumber,
                                                   secondaryAuthCredential: .email,
                                                   allowedCountries: [dataProvider.usa],
                                                   mode: .embedded)
    private let dataReceiver = AuthDataReceiverSpy()
...
extension AuthInteractorTest {
    func testPhoneIsPrimaryCredentialOfNewUserVerificationSucceededCreateUserCalled() {
        ...
        // Then
        XCTAssertTrue(platform.createUserCalled)
    }
    ...
    func testPhoneIsPrimaryCredentialOfExistingUserVerificationSucceededShowSecondaryCredentialVerification() {
        // Given
        let secondaryVerification = Verification(verificationId: "", verificationType: .email, status: .pending)
        let verification = Verification(verificationId: "", verificationType: .phoneNumber, status: .passed,
                                        secret: nil, secondaryCredential: secondaryVerification)
    ...
    func testPhoneIsSecondaryCredentialOfExistingUserVerificationSucceededRecoverUserFailsShowError() {
        ...
        givenEmailPrimaryCredential()
        sut.internalUserData.emailDataPoint.verification = Verification(verificationId: "", verificationType: .email,
                                                                        status: .passed)
    ...
    func testPhoneVerificationPendingPhoneVerificationFailed() {
        ...
        phoneDataPoint.verification = Verification(verificationId: "", verificationType: .phoneNumber, status: .pending)
...
extension AuthInteractorTest {
    ...
    func testEmailIsPrimaryCredentialOfExistingUserVerificationSucceededShowSecondaryCredentialVerification() {
        // Given
        givenEmailPrimaryCredential()
        let secondaryVerification = Verification(verificationId: "", verificationType: .phoneNumber, status: .pending)
        let verification = Verification(verificationId: "", verificationType: .email, status: .passed, secret: nil,
    ...
    func testEmailIsSecondaryCredentialOfExistingUserVerificationSucceededRecoverUserFailsShowError() {
        ...
        serviceLocator.setUpSessionForLoginUserWithVerificationFailure()
        givenPhonePrimaryCredential()
        sut.internalUserData.phoneDataPoint.verification = Verification(verificationId: "", verificationType: .phoneNumber,
                                                                        status: .passed)
        let verification = Verification(verificationId: "",
    ...
    func testEmailVerificationPendingEmailVerificationFailed() {
        ...
        emailDataPoint.verification = Verification(verificationId: "", verificationType: .email, status: .pending)
...
extension AuthInteractorTest {
    ...
    func testBirthDateIsPrimaryCredentialOfExistingUserVerificationSucceededShowSecondaryCredentialVerification() {
        ...
        givenBirthDatePrimaryCredential()
        let secondaryVerification = Verification(verificationId: "", verificationType: .email, status: .pending)
        let verification = Verification(verificationId: "", verificationType: .birthDate, status: .passed, secret: nil,
                                        secondaryCredential: secondaryVerification)
    ...
    func testBirthDateVerificationPendingBirthDateVerificationFailed() {
        ...
        birthDateDataPoint.verification = Verification(verificationId: "", verificationType: .birthDate, status: .pending)
