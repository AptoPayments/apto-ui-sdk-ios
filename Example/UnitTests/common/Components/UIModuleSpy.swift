...
class UIModuleSpy: UIModule {
    ...
    override func present(viewController: UIViewController, animated: Bool, embedInNavigationController: Bool,
                          showNavigationBar _: Bool = true, presentationStyle _: UIModalPresentationStyle? = nil,
                          completion: @escaping (() -> Void))
    {
        presentViewControllerCalled = true
        lastViewControllerPresented = viewController
        lastViewControllerPresentedAnimated = animated
        lastViewControllerPresentedEmbedded = embedInNavigationController
    ...
    private(set) var lastModuleReplacePrevious: Bool?
                       ...
                       completion: @escaping Result<UIViewController, NSError>.Callback)
    {
        ...
        lastModuleReplacePrevious = replacePrevious
    ...
    override func present(module: UIModuleProtocol,
                          ...
                          presenterController _: UIViewController? = nil,
                          completion: @escaping Result<UIViewController, NSError>.Callback)
    {
