...
class AptoPlatformFake: AptoPlatformProtocol {
    ...
    func saveOauthUserData(_ userData: DataPointList, custodian _: Custodian,
    ...
    func issueCard(applicationId: String, metadata _: String?,
                   design _: IssueCardDesign?, callback: @escaping Result<Card, NSError>.Callback)
    {
    ...
    func fetchCards(pagination _: PaginationQuery?, callback: @escaping (Result<PaginatedCardList, NSError>) -> Void) {
    ...
    func getPaymentSources(_: PaginationQuery?, callback _: @escaping Result<[PaymentSource], NSError>.Callback) {}
    func addPaymentSource(with _: PaymentSourceRequest, callback _: @escaping Result<PaymentSource, NSError>.Callback) {}
    func deletePaymentSource(paymentSourceId _: String, callback _: @escaping Result<Void, NSError>.Callback) {}
    func pushFunds(with _: PushFundsRequest, callback _: @escaping Result<PaymentResult, NSError>.Callback) {}

    func reviewAgreement(_: AgreementRequest, callback _: @escaping (RecordedAgreementsResult) -> Void) {}
    func assignAchAccount(balanceId _: String, callback _: @escaping (ACHAccountResult) -> Void) {}

    func orderPhysicalCard(_: String, callback _: @escaping (Result<Card, NSError>) -> Void) {}
    func getOrderPhysicalCardConfig(_: String, callback _: @escaping (Result<PhysicalCardConfig, NSError>) -> Void) {}

    func p2pFindRecipient(phone _: PhoneNumber?,
                          email _: String?,
                          callback _: @escaping (P2PTransferRecipientResult) -> Void) {}

    func inviteUser(phone _: PhoneNumber?,
                    email _: String?,
                    callback _: @escaping (P2PInviteResult) -> Void) {}

    func p2pMakeTransfer(transferRequest _: P2PTransferRequest,
                         callback _: @escaping (P2PTransferResult) -> Void) {}
    func startApplePayInAppProvisioning(cardId _: String, certificates _: [Data], nonce _: Data, nonceSignature _: Data, callback _: @escaping (ApplePayIAPResult) -> Void) {}
}
