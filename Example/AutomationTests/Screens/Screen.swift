...
class Screen {
    ...
    func nextAvailable() -> Bool {
        return isViewPresentWith(accessibilityLabel: "Navigation Next Button")
    }

    func previousAvailable() -> Bool {
        return isViewPresentWith(accessibilityLabel: "Navigation Previous Button")
    }

    func closeAvailable() -> Bool {
        return isViewPresentWith(accessibilityLabel: "Navigation Close Button")
    }
